...
Excitonic effects has been studies also in two-photon absorption and third-harmonic generation, see Ref.~\onlinecite{attaccalite1d,attaccalite2018two}. In the later case, contrary to the SHG, it has been found that electron-hole interaction reduce the response function intensity compared to the independent particle case.\\ 
