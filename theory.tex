...
First, in treating crystalline solids one imposes periodic boundary conditions to reflect the periodicity of the lattice and the Bloch functions. With periodic boundary conditions, the position operator, that is not periodic, is ill-defined. Then, a definition of the dipole operator, and thuso of the polarisanility,  that relies on the position is ill-defined.% in periodic systems, because $\vec \rr$ is not periodic while wave-functions are. WF ARE NOT PERIODIC... BLOCH THEO
